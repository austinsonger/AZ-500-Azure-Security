...
1.  Complete steps 1-8 again, but in step 3, name the virtual machine *AZ500-SE-VM-Internal* and in step 5, select the **Internal** subnet.
...
4.  Close the remote desktop session to the *AZ500-SE-VM* VM.
